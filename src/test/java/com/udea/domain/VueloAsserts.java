...
public class VueloAsserts {
    ...
    public static void assertVueloUpdatableRelationshipsEquals(Vuelo expected, Vuelo actual) {
        assertThat(actual)
            .as("Verify Vuelo relationships")
            .satisfies(a -> assertThat(a.getAeropuertoOrigen()).as("check aeropuertoOrigen").isEqualTo(expected.getAeropuertoOrigen()))
            .satisfies(a -> assertThat(a.getAeropuertoDestino()).as("check aeropuertoDestino").isEqualTo(expected.getAeropuertoDestino()))
            .satisfies(a -> assertThat(a.getAvion()).as("check avion").isEqualTo(expected.getAvion()))
            .satisfies(a -> assertThat(a.getPiloto()).as("check piloto").isEqualTo(expected.getPiloto()));
    }
}
