...
class AsientoResourceIT {
    ...
    private static final ClaseAsiento DEFAULT_CLASE = ClaseAsiento.ECONOMICA;
    private static final ClaseAsiento UPDATED_CLASE = ClaseAsiento.EJECUTIVA;
    ...
    void partialUpdateAsientoWithPatch() throws Exception {
        ...
        partialUpdatedAsiento.clase(UPDATED_CLASE).disponible(UPDATED_DISPONIBLE);
