...
import static com.udea.domain.PagoAsserts.*;
import static com.udea.web.rest.TestUtil.createUpdateProxyForBean;
import static com.udea.web.rest.TestUtil.sameNumber;
...
class PagoResourceIT {
    ...
    private static final MetodoPago DEFAULT_METODO = MetodoPago.TARJETA_CREDITO;
    private static final MetodoPago UPDATED_METODO = MetodoPago.TARJETA_DEBITO;
    ...
    public static Pago createEntity() {
        return new Pago().fechaPago(DEFAULT_FECHA_PAGO).monto(DEFAULT_MONTO).metodo(DEFAULT_METODO);
    }
    ...
    public static Pago createUpdatedEntity() {
        return new Pago().fechaPago(UPDATED_FECHA_PAGO).monto(UPDATED_MONTO).metodo(UPDATED_METODO);
    }
    ...
    @Test
    @Transactional
    void checkMetodoIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        pago.setMetodo(null);
    ...
    void putExistingPago() throws Exception {
        ...
        updatedPago.fechaPago(UPDATED_FECHA_PAGO).monto(UPDATED_MONTO).metodo(UPDATED_METODO);
    ...
    void fullUpdatePagoWithPatch() throws Exception {
        ...
        partialUpdatedPago.fechaPago(UPDATED_FECHA_PAGO).monto(UPDATED_MONTO).metodo(UPDATED_METODO);
