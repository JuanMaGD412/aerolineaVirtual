...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AEROPUERTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AEROPUERTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AEROPUERTO actions', async () => {
      const arg = { id: 16342 };
    ...
    it('dispatches UPDATE_AEROPUERTO actions', async () => {
      const arg = { id: 16342 };
    ...
    it('dispatches PARTIAL_UPDATE_AEROPUERTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AEROPUERTO actions', async () => {
      const arg = 42666;
