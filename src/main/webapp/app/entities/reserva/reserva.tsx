          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="aerolineaVirtualApp.reserva.asiento">Asiento</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {reservaList.map((reserva, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`aerolineaVirtualApp.EstadoReserva.${reserva.estado}`} />
                  </td>
