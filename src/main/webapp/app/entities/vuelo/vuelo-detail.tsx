    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{vueloEntity.aeropuertoOrigen ? vueloEntity.aeropuertoOrigen.id : ''}</dd>
          <dt>
            <Translate contentKey="aerolineaVirtualApp.vuelo.aeropuertoDestino">Aeropuerto Destino</Translate>
          </dt>
          <dd>{vueloEntity.aeropuertoDestino ? vueloEntity.aeropuertoDestino.id : ''}</dd>
          <dt>
            <Translate contentKey="aerolineaVirtualApp.vuelo.avion">Avion</Translate>
          </dt>
          <dd>{vueloEntity.avion ? vueloEntity.avion.id : ''}</dd>
          <dt>
            <Translate contentKey="aerolineaVirtualApp.vuelo.piloto">Piloto</Translate>
          </dt>
          <dd>{vueloEntity.piloto ? vueloEntity.piloto.id : ''}</dd>
        </dl>
