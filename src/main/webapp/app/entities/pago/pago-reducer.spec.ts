...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './pago.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAGO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAGO actions', async () => {
      const arg = { id: 25202 };
    ...
    it('dispatches UPDATE_PAGO actions', async () => {
      const arg = { id: 25202 };
    ...
    it('dispatches PARTIAL_UPDATE_PAGO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAGO actions', async () => {
      const arg = 42666;
