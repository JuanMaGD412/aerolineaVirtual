...
export const AsientoUpdate = () => {
  ...
  const claseAsientoValues = Object.keys(ClaseAsiento);
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                type="select"
              >
                {claseAsientoValues.map(claseAsiento => (
                  <option value={claseAsiento} key={claseAsiento}>
                    {translate(`aerolineaVirtualApp.ClaseAsiento.${claseAsiento}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
