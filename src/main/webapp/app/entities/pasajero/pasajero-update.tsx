        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField
                label={translate('aerolineaVirtualApp.pasajero.documentoIdentidad')}
                id="pasajero-documentoIdentidad"
                name="documentoIdentidad"
                data-cy="documentoIdentidad"
                type="text"
                validate={{
                  required: { value: true, message: translate('entity.validation.required') },
                }}
              />
              <ValidatedField
                label={translate('aerolineaVirtualApp.pasajero.nacionalidad')}
                id="pasajero-nacionalidad"
                name="nacionalidad"
