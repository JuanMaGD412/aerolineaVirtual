...
import { deleteEntity, getEntity } from './empleado.reducer';

export const EmpleadoDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/empleado${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="aerolineaVirtualApp.empleado.delete.question">
        <Translate contentKey="aerolineaVirtualApp.empleado.delete.question" interpolate={{ id: empleadoEntity.id }}>
