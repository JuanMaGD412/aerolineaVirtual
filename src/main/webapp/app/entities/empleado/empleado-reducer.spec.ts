...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './empleado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLEADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPLEADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPLEADO actions', async () => {
      const arg = { id: 25035 };
    ...
    it('dispatches UPDATE_EMPLEADO actions', async () => {
      const arg = { id: 25035 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPLEADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPLEADO actions', async () => {
      const arg = 42666;
