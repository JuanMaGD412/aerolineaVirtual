  ...
  return (
    <div>
      <h2 id="empleado-heading" data-cy="EmpleadoHeading">
        <Translate contentKey="aerolineaVirtualApp.empleado.home.title">Empleados</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="aerolineaVirtualApp.empleado.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/empleado/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="aerolineaVirtualApp.empleado.home.createLabel">Create new Empleado</Translate>
          </Link>
        </div>
      </h2>
        ...
        {empleadoList && empleadoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="aerolineaVirtualApp.empleado.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('cargo')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('cargo')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/empleado/${empleado.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="aerolineaVirtualApp.empleado.home.notFound">No Empleados found</Translate>
            </div>
          )
        )}
      </div>
