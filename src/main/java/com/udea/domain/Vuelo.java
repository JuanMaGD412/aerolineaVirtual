...
public class Vuelo implements Serializable {
    ...
    public Vuelo aeropuertoOrigen(Aeropuerto aeropuerto) {
        this.setAeropuertoOrigen(aeropuerto);
        return this;
    }
    ...
    public Vuelo aeropuertoDestino(Aeropuerto aeropuerto) {
        this.setAeropuertoDestino(aeropuerto);
        return this;
    }
    ...
    public void setPiloto(Empleado empleado) {
        this.piloto = empleado;
    }

    public Vuelo piloto(Empleado empleado) {
        this.setPiloto(empleado);
        return this;
    }
    ...
    public Vuelo addAsiento(Asiento asiento) {
        this.asientos.add(asiento);
        asiento.setVuelo(this);
        return this;
    }

    public Vuelo removeAsiento(Asiento asiento) {
