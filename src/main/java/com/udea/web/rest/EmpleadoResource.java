...
/**
 * REST controller for managing {@link com.udea.domain.Empleado}.
 */
@RestController
...
public class EmpleadoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Empleado>> getAllEmpleados(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
